...
EMAIL_ACCOUNT_MAP = {
    ...
    'support': (os.environ.get('SUPPORT_EMAIL', None), os.environ.get('SUPPORT_EMAIL_PASSWORD', None)),
    # non-reply email for sending confirmation email etc
    'noreply': (os.environ.get('SUPPORT_EMAIL', None), os.environ.get('SUPPORT_EMAIL_PASSWORD', None)),
